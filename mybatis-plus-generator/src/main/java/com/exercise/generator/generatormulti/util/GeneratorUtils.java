...
package com.exercise.generator.generatormulti.util;
...
public class GeneratorUtils {
    ...
    public static String resolveFieldName(String getMethodName) {
        ...
        // 小写第一个字母
        return GeneratorUtils.firstToLowerCase(getMethodName);
    }
...
//        if (GeneratorUtils.isNotEmpty(content) && ArrayUtils.isNotEmpty(args)) {

...
import com.exercise.generator.generatormulti.config.converts.MySqlTypeConvert;
import com.exercise.generator.generatormulti.config.querys.MySqlQuery;
import lombok.Data;
    ...
    public DbType getDbType() {
        if (null == this.dbType) {
            ...
            if (null == this.dbType) {
                ...
                if (null == this.dbType) {
                    System.out.println("Unknown type of database!");
                }
            }
        }

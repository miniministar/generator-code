...
public class CodeGenerator {
    ...
    private static String BASE_PACK = "com.exercise.generator.sample";
     ...
     * 驱动连接的URL
     */
    private static String DB_URL = "jdbc:mysql://rm-bp1uiz137e6th9b3g2o.mysql.rds.aliyuncs.com/eladmin?autoReconnect=true&createDatabaseIfNotExist=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    /**
     * 驱动名称
     */
     ...
     * 数据库连接密码
     */
    private static String DB_PASSWORD = "AKFV9K!jvcwF";
    /**
     * 表前缀
     */
    private static String TABLE_PREFIX = "fss_";
    /**
     * 表名
     */
    private static String[] TABLE_NAMES = {"fss_supplier_settlement"};
...
//                return PROJECT_PATH + "/src/main/java/" + basePackPath + "/model/vo/" + entityPath.toLowerCase() + "/Get" + entityPath + "ReqVo" + StringPool.DOT_JAVA;
                return PROJECT_PATH + "/src/main/java/" + basePackPath + "/model/vo/Get" + entityPath + "ReqVo" + StringPool.DOT_JAVA;
            }
        });
        // GetResVo
        focList.add(new FileOutConfig("/template/GetResVo.java.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                String entityPath = tableInfo.getEntityName().replace("Entity", "");
                return PROJECT_PATH + "/src/main/java/" + basePackPath + "/model/vo/" + entityPath.toLowerCase() + "/Get" + entityPath + "ResVo" + StringPool.DOT_JAVA;
            }
        });
        // AddReqVo
        ...
        // ModifyReqVo
        focList.add(new FileOutConfig("/template/ModifyReqVo.java.ftl") {
            @Override
            public String outputFile (TableInfo tableInfo){
                String entityPath = tableInfo.getEntityName().replace("Entity", "");
...
//        globalConfig.setEntityName("%s" + ENTITY_SUFFIX);
    ...
    private static PackageConfig initPackageConfig() {
        ...
        //Entity包名
        packageConfig.setEntity("model." + ENTITY_FOLDER);
        //Service包名
